...
exports.PasswordModule = PasswordModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: password_schema_1.Password.name, schema: password_schema_1.PasswordSchema },
                { name: list_schema_1.List.name, schema: list_schema_1.ListSchema }
            ])],
